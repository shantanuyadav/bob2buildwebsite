...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'Visionary leader with 5+ years of experience in web development and digital strategy. Daksh founded bob2build with a mission to help startups and growing businesses succeed online. He specializes in architecting scalable web solutions and understanding the unique challenges faced by tech-savvy entrepreneurs.',
    expertise: [
      'Web Architecture',
      'Technical Strategy',
  ...
  },
  {
    ...
    bio: 'Technical architect and innovation driver with deep expertise in building scalable web applications. Tanmay leads our engineering team and ensures we deliver cutting-edge solutions using modern technologies. He is passionate about creating efficient, maintainable code that powers business growth.',
    expertise: [
      'System Architecture',
